...
| Dataset name `<DATASET>` | Paper dataset        | Number of fields | Path-info file                                     |
| ------------------------ | -------------------- | ---------------: | -------------------------------------------------- |
| `ImageText`              | Image-Text           |                2 | `dataset/path_info_CC1MNorm_2field_100W.txt`       |
| `QA2`                    | Question-Answer      |                4 | `dataset/path_info_LMSYSType2Norm_4field_100W.txt` |
| `Wiki`                   | Wikipedia            |                6 | `dataset/path_info_EnwikiNorm_6field_100W.txt`     |
| `Protein`                | Protein              |                8 | `dataset/path_info_ProteinNorm_8field_100W.txt`    |
| `New`                    | User-defined dataset |     user-defined | `dataset/path_info_New.txt`                        |
